...
let IconPictureFilling: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconPictureFilling = React.memo ? React.memo(IconPictureFilling) : IconPictureFilling;

export default IconPictureFilling;
