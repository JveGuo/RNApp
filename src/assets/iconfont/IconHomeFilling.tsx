...
let IconHomeFilling: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconHomeFilling = React.memo ? React.memo(IconHomeFilling) : IconHomeFilling;

export default IconHomeFilling;
