...
let IconUserFilling: FunctionComponent<Props> = ({ size, color, ...rest }) => {
  return (
...
IconUserFilling = React.memo ? React.memo(IconUserFilling) : IconUserFilling;

export default IconUserFilling;
